...
const en = {
  ...
  providers: {
    ...
    proxySection: "Connection",
    proxyEnable: "Send speech through a proxy",
    proxyHint:
      "Only the speech connection. Turn this on when dictation is slow or loses the end of a sentence — that is a lossy route to the provider, not a slow computer.",
    proxyAddress: "Proxy address",
    proxyAddressHint: "host:port, for example 10.0.0.1:3128.",
    proxyCredentials: "Username & password",
    proxyCredentialsHint:
      "Format username:password. Leave empty for a proxy that needs no login. Saved to the credential store, never to settings.",
    proxyCredentialsPlaceholder: "username:password",
    proxyTestHint: "Use Test connection above to check it — that call takes the same route.",
...
const vi: Dictionary = {
  ...
  providers: {
    ...
    proxySection: "Kết nối",
    proxyEnable: "Cho giọng nói đi qua proxy",
    proxyHint:
      "Chỉ áp cho kết nối giọng nói. Bật khi đọc chính tả bị chậm hoặc mất đuôi câu — đó là đường truyền tới nhà cung cấp bị mất gói, không phải máy yếu.",
    proxyAddress: "Địa chỉ proxy",
    proxyAddressHint: "host:port, ví dụ 10.0.0.1:3128.",
    proxyCredentials: "Tài khoản & mật khẩu",
    proxyCredentialsHint:
      "Dạng tài_khoản:mật_khẩu. Để trống nếu proxy không cần đăng nhập. Lưu vào kho khoá, không ghi vào file cài đặt.",
    proxyCredentialsPlaceholder: "tài_khoản:mật_khẩu",
    proxyTestHint: "Bấm Kiểm tra kết nối ở trên để thử — lượt gọi đó đi đúng đường này.",
